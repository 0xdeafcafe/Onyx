    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DatabaseContext>
    {
        ...
        protected override void Seed(DatabaseContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                {
                    Username = "OnyxTest",
                    Password = "1000:c1JY6wtgSaAoIL2b8TDp7MCJeMyDO4A/:fkGpJleo1noIkvhC6gzHM4vNZjPMr0mz",
                    Email = "xerax@xboxchaos.com",
                    RoleId = context.Roles.First(r => r.Identifier == Roles.Administrator).Id
                });
                context.SaveChanges();
            }
        }
