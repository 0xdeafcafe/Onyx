...
window.onload = function () {
    document.getElementById("project-stfs-upload").addEventListener("change", function (event) {
        var stfsFile = event.target.files[0];

        XboxInternals.IO.FileIO.LoadFromFile(stfsFile, function (io) {
            try  {
